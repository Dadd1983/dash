                  ...
                  <div class="row">
                    <div class="col-3">
                      <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link active" id="product-1-tab" data-toggle="pill" @click="imageShow($event)" role="tab">
                      ...
                      <div class="tab-content" id="v-pills-tabContent">
                        <div class="tab-pane fade show active" id="product-1" role="tabpanel">
                          <div class="product-img">
                            <img id="expandedImg" src="@/assets/images/product/img-1.png" alt class="img-fluid mx-auto d-block" />
                          </div>
                        </div>
                      </div>
                ...
                <div class="mt-4 mt-xl-3">
                  ...
                  <div class="d-inline-flex">
                    <div class="text-muted me-3">
                      <span class="mdi mdi-star text-warning me-1"></span>
                      <span class="mdi mdi-star text-warning me-1"></span>
                      <span class="mdi mdi-star text-warning me-1"></span>
                      <span class="mdi mdi-star text-warning me-1"></span>
                  ...
                  <h5 class="mt-2">
                    <del class="text-muted me-2">$252</del>$240
                    <span class="text-danger font-size-12 ms-2">25 % Off</span>
                  </h5>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div>
                        ...
                        <ul class="list-unstyled product-desc-list">
                          <li>
                            <i class="mdi mdi-circle-medium me-1 align-middle"></i> Full Sleeve
                          </li>
                          <li>
                            <i class="mdi mdi-circle-medium me-1 align-middle"></i> Cotton
                          </li>
                          <li>
                            <i class="mdi mdi-circle-medium me-1 align-middle"></i> All Sizes available
                          </li>
                          <li>
                            <i class="mdi mdi-circle-medium me-1 align-middle"></i> 4 Different Color
                          </li>
                        </ul>
                      </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                      ...
                      <ul class="list-unstyled product-desc-list">
                        <li>
                          <i class="mdi mdi-sync text-primary me-1 align-middle font-size-16"></i> 10 Days Replacement
                        </li>
                        <li>
                          <i class="mdi mdi-currency-usd-circle text-primary me-1 align-middle font-size-16"></i> Cash on Delivery available
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <b-tabs class="nav-tabs-custom" content-class="border border-top-0 p-4">
                  <b-tab title="Description">
                    <div>
                      ...
                      <div>
                        <p class="mb-2">
                          <i class="mdi mdi-circle-medium me-1 align-middle"></i> If several languages coalesce
                        </p>
                        <p class="mb-2">
                          <i class="mdi mdi-circle-medium me-1 align-middle"></i> To an English person, it will seem like simplified
                        </p>
                        <p class="mb-0">
                          <i class="mdi mdi-circle-medium me-1 align-middle"></i> These cases are perfectly simple.
                        </p>
                      </div>
                    </div>
                  </b-tab>
            ...
            <div class="mt-4">
              ...
              <div class="border p-4 rounded">
                  ...
                  <div class="flex-grow-1">
                    ...
                    <ul class="list-inline product-review-link mb-0">
                      <li class="list-inline-item">
                        <a href="#">
                          <i class="mdi mdi-thumb-up align-middle me-1"></i> Like
                        </a>
                      </li>
                      <li class="list-inline-item">
                        <a href="#">
                          <i class="mdi mdi-message-text align-middle me-1"></i> Comment
                        </a>
                      </li>
                    </ul>
                  </div>
                  <p class="float-sm-right font-size-12">11 Feb, 2024</p>
                </div>
                <div class="d-flex border-bottom py-3">
                  ...
                  <p class="float-sm-right font-size-12">22 Jan, 2024</p>
                </div>
                <div class="d-flex py-3">
                  ...
                  <p class="float-sm-right font-size-12">04 Jan, 2024</p>
                </div>
              </div>
            </div>
          </div>
